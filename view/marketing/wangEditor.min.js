! function(t, e) {
  ...
  function d(t, e) {
    ...
    var r = o('<div class="w-e-droplist"></div>'),
      a = e.$title,
      c = void 0;
    a && (c = a.html(), c = J(i, c), a.html(c), a.addClass("w-e-dp-title"), r.append(a));
    var A = e.list || [],
      s = e.type || "list",
      l = e.onClick || O,
  ...
  function U(t, e) {
    ...
    if(null == n ? i = window.clipboardData && window.clipboardData.getData("text") : (i = n.getData("text/plain"), o = n.getData("text/html")), !o && i && (o = "<p>" + A(i) + "</p>"), o) {
      var r = o.split("</html>");
      return 2 === r.length && (o = r[0]), o = o.replace(/<(meta|script|link).+?>/gim, ""), o = o.replace(/<!--.*?-->/gm, ""), o = o.replace(/\s?data-.+?=('|").+?('|")/gim, ""), o = e ? o.replace(/\s?(class|style)=('|").+?('|")/gim, "") : o.replace(/\s?class=('|").+?('|")/gim, "")
    }
  }
  ...
  function Y(t, e) {
    ...
    this.id = "wangEditor-" + K++, this.toolbarSelector = t, this.textSelector = e, this.customConfig = {}
  }
  var L = [];
  i.prototype = {
    constructor: i,
  ...
  p.prototype = {
    ...
    show: function() {
      ...
      if(!($.indexOf(e) >= 0)) {
        ...
        g.length && g.get(0).focus(), this.$container = c, this._hideOtherPanels(), $.push(e)
      }
    },
    hide: function() {
      var t = this.menu,
        e = this.$container;
      e && e.remove(), $ = $.filter(function(e) {
        return e !== t
      })
    },
    ...
    onClick: function(t) {
      var e = this.editor,
        n = e.selection.getSelectionContainerElem(),
        i = n.getNodeName();
      if(!z.isIE()) return void("BLOCKQUOTE" === i ? e.cmd.do("formatBlock", "<P>") : e.cmd.do("formatBlock", "<BLOCKQUOTE>"));
      var r = void 0,
        a = void 0;
    ...
    _insert: function(t, e) {
      ...
      for(n = 0; n < t; n++) {
        if(o += "<tr>", 0 === n)
          for(i = 0; i < e; i++) o += "<th>&nbsp;</th>";
        else
          for(i = 0; i < e; i++) o += "<td>&nbsp;</td>";
        o += "</tr>"
      }
      o += "</table><p><br></p>";
      var r = this.editor;
  ...
  var q = {};
  q.bold = l, q.head = u, q.link = h, q.italic = f, q.redo = g, q.strikeThrough = m, q.underline = w, q.undo = v, q.list = b, q.justify = x, q.foreColor = y, q.backColor = E, q.quote = B, q.code = C, q.emoticon = I, q.table = Q, q.video = _, q.image = D, k.prototype = {
    constructor: k,
    init: function() {
      var t = this,
        e = this.editor;
    ...
    _pasteHandle: function() {
      ...
      a.on("paste", function(i) {
        if(!z.isIE() && (i.preventDefault(), t())) {
          ...
          if(A) {
            var l = A.getNodeName();
            if("CODE" === l || "PRE" === l) return r && s(r) && (c = "" + (r(c) || "")), void n.cmd.do("insertHTML", "<p>" + c + "</p>");
            if(!a) return void e();
            try {
              r && s(r) && (a = "" + (r(a) || "")), n.cmd.do("insertHTML", a)
            } catch(t) {
              r && s(r) && (c = "" + (r(c) || "")), n.cmd.do("insertHTML", "<p>" + c + "</p>")
            }
          }
        }
      }), a.on("paste", function(e) {
        if(!z.isIE() && (e.preventDefault(), t())) {
          var i = S(e);
          if(i && i.length) {
    ...
    createEmptyRange: function() {
      ...
      if(e && this.isSelectionEmpty()) try {
        z.isWebkit() ? (t.cmd.do("insertHTML", "&#8203;"), e.setEnd(e.endContainer, e.endOffset + 1), this.saveRange(e)) : (n = o("<strong>&#8203;</strong>"), t.cmd.do("insertElem", n), this.createRangeByElem(n, !0))
      } catch(t) {}
    },
      ...
      if(t && t.length) {
        ...
        if(w || o || c) {
          ...
          if(a(v, function(t) {
            ...
            var E = y[1] || "";
            r(u, function(t, e) {
              e = encodeURIComponent(e), p && (o.indexOf("?") > 0 ? o += "&" : o += "?", o = o + t + "=" + e), x.append(t, e)
            }), E && (o += "#" + E);
            ...
            if(B.open("POST", o), B.timeout = g, B.ontimeout = function() {
                ...
                if(4 === B.readyState) {
                  ...
                  if(t = B.responseText, "object" !== (void 0 === t ? "undefined" : W(t))) try {
                    t = JSON.parse(t)
                  } catch(i) {
              ...
              if(C && "object" === (void 0 === C ? "undefined" : W(C)) && C.prevent) return void this._alert(C.msg)
            }
            return r(h, function(t, e) {
              B.setRequestHeader(t, e)
            }), B.withCredentials = m, void B.send(x)
          }
          c && a(t, function(t) {
            var n = e,
              i = new FileReader;
  ...
  Y.prototype = {
    ...
    _initConfig: function() {
      var t = {};
      this.config = Object.assign(t, P, this.customConfig);
    ...
    _initDom: function() {
      ...
      A.attr("id", u);
      var p = c("text-elem");
      l.attr("id", p), this.$toolbarElem = A, this.$textContainerElem = s, this.$textElem = l, this.toolbarElemId = u, this.textElemId = p;
      var h = !0;
    ...
    _initUploadImg: function() {
      this.uploadImg = new H(this)
    },
    _initMenus: function() {
      this.menus = new k(this), this.menus.init()
    },
    _initText: function() {
      this.txt = new R(this), this.txt.init()
    },
