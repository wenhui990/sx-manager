...
var recharges = new Vue({
	...
	methods: {
		...
		exportReport: function(e) { //导出学生
			$(e.target).prop('href', org_url + dataUrl.downloadReport + '?type=1&loginname='+recharges.rechargcard.trim()+'&schoolname=' + recharges.schoolsVal + '&usertype=' + recharges.typename + '&username=' + recharges.rechargename.trim() + '&timefrom=' + $('#date1').val() + '&timeto=' + $('#date2').val() + '&token=' + localStorage.token);
		},
	}
});
